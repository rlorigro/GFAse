...
void phase_hic(path output_dir, path gfa_path, string required_prefix, int8_t min_mapq, size_t n_threads){
    Timer t;
...
int main (int argc, char* argv[]){
    ...
    phase_hic(output_dir, gfa_path, required_prefix, min_mapq, n_threads);
